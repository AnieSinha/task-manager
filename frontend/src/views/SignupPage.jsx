...
export function SignupPage({ onGoToLogin }) {
  ...
  const clearErr = (field) =>
    setFieldErr((p) => ({ ...p, [field]: undefined }));
      ...
      <div className="auth-card">
        ...
        <form className="auth-form" onSubmit={handleSubmit} noValidate>
          ...
          <div className="form-group">
            ...
            />
            {fieldErr.name && (
              <span className="field-error">{fieldErr.name}</span>
            )}
          </div>
          ...
          <div className="form-group">
            ...
            />
            {fieldErr.confirm && (
              <span className="field-error">{fieldErr.confirm}</span>
            )}
          </div>
      ...
      <div className="pw-strength-bars">
        {[1, 2, 3, 4, 5].map((i) => (
          <div
            ...
            style={{
              backgroundColor: i <= s ? COLORS[s] : "var(--colors-surface-2)",
            }}
          />
        ))}
      </div>
