...
export const tasks = {
  ...
  assignments: {
    ...
    assign: (taskId, assignedTo, reason) =>
      post(`/tasks/${taskId}/assignments`, { assigned_to: assignedTo, reason }),
    remove: (taskId, assignmentId) =>
      del(`/tasks/${taskId}/assignments/${assignmentId}`),
  },
};
