...
const SEED = [
  {
    ...
    body: "Elena Rostova updated 'Write Token Parser Test Suite'.",
    time: "2m ago",
    read: false,
  },
  {
    ...
    body: "Marcus Vance added 'Webhook Export Infrastructure'.",
    time: "1h ago",
    read: false,
  },
  {
    ...
    body: "Alex Chen completed 'Configure HTTPS Secret Routes'.",
    time: "3h ago",
    read: true,
  },
  {
    ...
    body: "'GitHub Credential Exchange Handshake' needs review.",
    time: "Yesterday",
    read: true,
  },
];
